...
- [x] M2: 기본 크롤링 PoC (YogiyoChecker 클래스)
- [x] M3: Google Sheets 연동 (google_sheets_client.py)
- [x] M4: main.py CLI 인터페이스 (Sheet ID 입력 → 자동 조회)
- [x] 셀렉터 백업 전략 (우선순위 1~3)
- [x] 메시지 분류 로직 (REGISTERED/AVAILABLE/INVALID)
- [x] 재시도 로직 및 에러 핸들링
- [x] 실시간 진행률 및 통계 출력

### 🔄 다음 버전
- [ ] M5: 대량 데이터 실전 테스트
- [ ] M6: 파라미터 최적화 (대기 시간, 딜레이)
- [ ] GUI 버전 개발 (tkinter)
- [ ] 배달의민족 통합 조회
- [ ] 자동 태깅 및 리포트 생성
